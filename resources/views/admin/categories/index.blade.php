@extends('layouts.app', ['title' => 'Category Manage'])
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 classic-data-table">
                            <thead>
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th class="min-w-225px">Category Name</th>
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                @foreach ($categoryList as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>
                                            {!! getStatus($row->status, route('categories.edit', $row->id)) !!}
                                        </td>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            tableData = @json($categoryList);
            actionurl = '{{ route('categories.store') }}';
        });
    </script>
@endpush
