                        ...
                        <div class="card">
                            <div class="card-header border-0 pt-6">
                                <div class="card-title">
                                    {{ in_array($user->role_id, [1, 2, 3, 4]) ? role()->name : '' }} Dashboard
                                </div>
                            </div>
                                                ...
                                                <div class="row g-0">
                                                        ...
                                                        <div class="d-flex align-items-center mb-9 me-2">
                                                            ...
                                                            <div>
                                                                <a href="{{ route('appointment.list') }}">
                                                                    <div class="fs-5 text-dark fw-bolder lh-1">{{ $total_appointment }}</div>
                                                                    <div class="fs-7 text-gray-600 fw-bold">Total Appointment</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="d-flex align-items-center mb-9 ms-2">
                                                            <div>
                                                                {{--<div class="fs-7 text-gray-600 fw-bold"><a href="#" class="text-dark text-hover-primary">View Details</a></div>--}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div>
                                                                <a href="{{ url('admin/doctors') }}">
                                                                    <div class="fs-5 text-dark fw-bolder lh-1">{{ $total_doctors }}</div>
                                                                    <div class="fs-7 text-gray-600 fw-bold">Total Doctors</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="d-flex align-items-center mb-9 me-2">
                                                            ...
                                                            <div>
                                                                <a href="{{ url('admin/services') }}">
                                                                    <div class="fs-5 text-dark fw-bolder lh-1">{{ $total_services }}</div>
                                                                    <div class="fs-7 text-gray-600 fw-bold">Total Services</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div>
                                                                <a href="{{ url('admin/departments') }}">
                                                                    <div class="fs-5 text-dark fw-bolder lh-1">{{ $total_departments }}</div>
                                                                    <div class="fs-7 text-gray-600 fw-bold">Total Departments</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row g-0">
                                                    <div class="col-6">
                                                        <div class="d-flex align-items-center mb-9 me-2">
                                                            ...
                                                            <div>
                                                                <a href="{{ url('admin/health-insurance') }}">
                                                                    <div class="fs-5 text-dark fw-bolder lh-1">{{ $total_health_insuranace }}</div>
                                                                    <div class="fs-7 text-gray-600 fw-bold">Total Insurance</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div>
                                                                <a href="{{ url('admin/health-packages') }}">
                                                                    <div class="fs-5 text-dark fw-bolder lh-1">{{ $total_health_pckg }}</div>
                                                                    <div class="fs-7 text-gray-600 fw-bold">Total Package</div>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
