@extends('layouts.app', ['title' => 'Suncity Dental care'])
        ...
        <div class="toolbar">
            <div class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Suncity Dental care</h1>
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Suncity Dental care</h3>
                        </div>
                    </div>
                    <!--begin::Card header-->
                    <!--begin::Content-->
                    ...
                    <div>
                        <!--begin::Form-->
                        <form action="{{ route('settingSync') }}" class="form" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="key" value="sunCityDentalCare">
                            <!--begin::Card body-->
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fv-row mb-7">
                                            ...
                                            <textarea type="text" name="options[description]"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="settings-status d-flex justify-content-end">
                                                ...
                                                {{-- <div>
                                                <a type="button" data-delete-url="{{ route('categories.destroy', $setting->id) }}"
                                                    class="btn btn-sm btn-danger delete-row">Delete</a>
                                            </div> --}}
                                            </div>
                                        </div>
                                    </div>
