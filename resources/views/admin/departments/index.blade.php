@extends('layouts.app', ['title' => 'Department Manage'])
...
<style>
    .department-img {
        ...
        margin-right: 5px;
        margin-left: 3px;
        box-shadow: 0px 0px 40px 0px rgb(76 87 125 / 12%);
    }
</style>
@endpush
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Department List</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Department List</li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 classic-data-table">
                            <thead>
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th></th>
                                    <th class="min-w-225px">Department</th>
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                @foreach ($departmentList as $row)
                                    <tr>
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td>
                                            <img class="department-img" src="{{ image($row->image) }}" alt="Department Image">
                                            {{ $row->name }}
                                        </td>
                                        <td>{{ $row->title }}</td>
                                        <td>
                                            {!! getStatus($row->status, route('departments.edit', $row->id)) !!}
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a type="button"
                                                        data-delete-url="{{ route('departments.destroy', $row->id) }}"
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder modal-title">Add Department</h2>
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" data-kt-scroll-offset="300px">
                            <div class="fv-row mb-7">
                                <div style="width: max-content; margin: 0 auto">
                                    <label class="d-block fw-bold fs-6 mb-5">Department Photo</label>
                                    <div class="image-input image-input-outline ml-2" data-kt-image-input="true">
                                        <div class="image-input-wrapper w-250px h-175px"></div>
                                        <label
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Enter Name" required />
                            </div>
                            <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea class="form-control form-control-solid mb-8" name="description" placeholder="Write description" required rows="8"></textarea>
                            </div>
                        </div>
