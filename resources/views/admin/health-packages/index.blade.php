@extends('layouts.app', ['title' => 'Health Package Manage'])
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Health Package List</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Health Package List</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 classic-data-table">
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                @foreach ($healthPackageList as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>{{ $row->price }}</td>
                                        <td>{{ $row->description }}</td>
                                        <td>
                                            {!! getStatus($row->status, route('health-packages.edit', $row->id)) !!}
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                ...
                                                <div class="menu-item px-3">
                                                    <a type="button"
                                                        data-delete-url="{{ route('health-packages.destroy', $row->id) }}"
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder modal-title">Add Health Package</h2>
                    ...
                    <form method="post">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" data-kt-scroll-offset="300px">
                            <div class="fv-row mb-7">
                                <label class="required fw-bold fs-6 mb-2">Health Package Name</label>
                                <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="Health Package Name" required />
                            </div>
                            <div class="fv-row mb-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea rows="8" name="description" class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="Write Package Description" required ></textarea>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            modalTitle = 'Add Health Package';
            tableData = @json($healthPackageList);
            actionurl = '{{ route('health-packages.store') }}';
        });
    </script>
@endpush
