@extends('layouts.app', ['title' => 'Our Happy Customer Says Manage'])
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Our Happy Customer Says List</h1>
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-dark">Our Happy Customer Says List</li>
                    </ul>
                </div>
            </div>
        </div>
                                ...
                                <div class="modal-dialog mw-650px">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h2 class="fw-bolder modal-title">Add New Our Happy Customer Says</h2>
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        <label class="d-block fw-bold fs-6 mb-5">Author Photo</label>
                                                        <div class="image-input image-input-outline ml-2"
                                                            data-kt-image-input="true">
                                                            <div class="image-input-wrapper w-120px h-125px"></div>
                                                            <label
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <input type="text" name="name"
                                                            ...
                                                            placeholder="Enter Custiner Name" required />
                                                    </div>
                                                    <div class="fv-row mb-7">
                                                        <label class="required fw-bold fs-6 mb-2">Message</label>
                                                        <textarea class="form-control form-control-solid mb-8" name="testimonial" rows="5"
                                                            placeholder="Write Our Happy Customer Says" required></textarea>
                                                    </div>
                                                </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 classic-data-table">
                            <thead>
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    <th>#</th>
                                    <th class="min-w-350px">Customer</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center me-3">
                                                <!--begin::Logo-->
                                                <img src="{{ image($row->photo) }}" class="me-4 w-80px" alt="">
                                                <!--end::Logo-->

                                                <!--begin::Section-->
                                                <div class="flex-grow-1">
                                                    <!--begin::Text-->
                                                    <span class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">{{ $row->name }}</span>
                                                    <!--end::Text-->
                                                </div>
                                                <!--end::Section-->
                                            </div>
                                        ...
                                        <td>
                                            {!! getStatus($row->status, route('testimonials.edit', $row->id)) !!}
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a type="button"
                                                        data-delete-url="{{ route('testimonials.destroy', $row->id) }}"
...
@push('scripts')
    <script>
        $(document).ready(function() {
            modalTitle = 'Add New Our Happy Customer Says';
            tableData = @json($testimonials);
            actionurl = '{{ route('testimonials.store') }}';
        });
    </script>
@endpush
