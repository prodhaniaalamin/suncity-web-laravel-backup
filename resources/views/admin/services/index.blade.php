@extends('layouts.app', ['title' => 'Service Manage'])
        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Service List</h1>
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn btn-primary add-new"
                                    data-add-click-modal-target="#serviceModal">
                                    Add Service
                                </button>
                            </div>
                        </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 classic-data-table">
                            <thead>
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-25px">Service Icon</th>
                            ...
                            <tbody class="text-gray-600 fw-bold">
                                ...
                                @foreach ($serviceList as $row)
                                    <tr>
                                        ...
                                        <td>
                                            {!! getStatus($row->status, route('services.edit', $row->id)) !!}
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a data-modal-show="#serviceModal" type="button"
                                                        id="edit_{{ $row->id }}" class="edit-show menu-link px-3"
                                                        aria-label="Edit">Edit</a>
                                                </div>
                                                <div class="menu-item px-3">
                                                    <a type="button"
                                                        data-delete-url="{{ route('services.destroy', $row->id) }}"
        ...
        <div class="modal-dialog mw-650px">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bolder modal-title">Add Service</h2>
                    ...
                    <form method="post">
                        ...
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" data-kt-scroll-offset="300px">
                            <div class="fv-row mb-7">
                                <label class="required fw-bold fs-6 mb-2">Service Title</label>
                                <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0"
                                    placeholder="Service Title" required />
                            </div>
                            <div class="fv-row mb-7">
                                <label class="required fw-bold fs-6 mb-2">Icon Class</label>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="description" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="write description" ></textarea>
                            </div>
                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            tableData = @json($serviceList);
            actionurl = '{{ route('services.store') }}';
        });
    </script>
@endpush
